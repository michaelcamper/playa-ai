...
export class SynthesizeSpeechResponseMetadata extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: SynthesizeSpeechResponseMetadata): SynthesizeSpeechResponseMetadata.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    ...
    static deserializeBinaryFromReader(message: SynthesizeSpeechResponseMetadata, reader: jspb.BinaryReader): SynthesizeSpeechResponseMetadata;
}
