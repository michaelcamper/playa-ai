...
import type { MicrophoneConfig } from "./microphone";
import { MicrophoneObservable } from "./microphone";
...
const rivaHost = process.env.RIVA_HOST || "localhost";
const rivaPort = process.env.RIVA_PORT || "50051";
